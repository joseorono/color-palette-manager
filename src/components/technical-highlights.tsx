...
function WorkflowCard({ icon, title, description }: WorkflowCardProps) {
  return (
    <div className="rounded-xl bg-white dark:bg-slate-900 p-6 border border-gray-200 dark:border-slate-700 transition-all hover:border-vivid-sky-blue dark:hover:border-vivid-sky-blue hover:shadow-lg">
...
export default function TechnicalHighlights() {
  ...
  return (
    <section id="tools" className="bg-azure-web-50 dark:bg-slate-800 py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-xl text-gray-600 dark:text-gray-300">
            Everything you need for professional color management and design systems
          </p>
        </div>
