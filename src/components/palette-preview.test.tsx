...
describe('PalettePreview', () => {
  describe('Basic Rendering', () => {
    it('should render palette with correct colors', () => {
      ...
      expect(container).toHaveAttribute('aria-label', 'Color palette with 3 colors');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle single color', () => {
      ...
      const container = screen.getByRole('img');
      expect(container).toHaveAttribute('aria-label', 'Color palette with 1 colors');
    ...
    it('should handle many colors', () => {
      ...
      const container = screen.getByRole('img');
      expect(container).toHaveAttribute('aria-label', 'Color palette with 20 colors');
  ...
  describe('Accessibility', () => {
    it('should have proper ARIA labels', () => {
      ...
      const colorSegments = screen.getAllByRole('button');
      expect(colorSegments[0]).toHaveAttribute('aria-label', 'Color 1: #FF5733');
      expect(colorSegments[1]).toHaveAttribute('aria-label', 'Color 2: #33FF57');
      expect(colorSegments[2]).toHaveAttribute('aria-label', 'Color 3: #3357FF');
    });
