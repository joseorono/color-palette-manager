              ...
              >
                <div className="mx-auto max-w-2xl">
                  ...
                  <p
                    ...
                    style={{ color: "var(--preview-foreground)" }}
                  >
                    Color harmony refers to the theory of combining colors in a
                    way that is harmonious to the eye. There are several classic
                    color schemes that are considered harmonious, including
                    complementary, analogous, triadic, and tetradic.
                  </p>
                  ...
                  >
                    ...
                    other, they create a strong contrast and can make each other
                    appear brighter.
                  </p>

                  <div className="my-6 flex justify-center">
                    <div
                      className="flex h-20 w-full max-w-md overflow-hidden rounded-lg border"
                  ...
                  >
                    ...
                    each other on the color wheel. They usually match well and
                  ...
                  >
                    ...
                    <p
                      ...
                      style={{ color: "var(--preview-muted-foreground)" }}
                    >
                      When using analogous colors, avoid combining warm and cool
                      colors. Choose colors that are all warm or all cool for
                      the best results.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    look, especially when used at full saturation. This color
                    scheme must be managed well so it is not jarring.
                  </p>
                  ...
                  <p
                    ...
                    style={{ color: "var(--preview-muted-foreground)" }}
                  >
                    Continue reading to learn about analogous color schemes and
                    how they differ from complementary colors in both appearance
                    and application...
                  </p>
                </div>
              </div>
